...
const redirectUri = "https://hakan.surge.sh/";
...
const Spotify = {
  getAccessToken() {
    ...
    if (accessTokenMatch && expiresInMatch) {
      ...
      const spotUrl = `${spotifyAuthorizeEndpoint}?client_id=${userId}&response_type=token&scope=playlist-modify-public&redirect_uri=${redirectUri}`;
      ...
      .then(jsonResponse => {
        ...
        return fetch(`${spotifyApiUrl}/users/${userId}/playlists`, {
          ...
          .then(jsonResponse => {
            ...
            return fetch(
              `${spotifyApiUrl}/users/${userId}/playlists/${playlistId}/tracks`,
              {
                headers: headers,
                method: "POST",
